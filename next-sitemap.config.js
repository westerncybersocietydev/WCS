...
const config = {
    ...
    exclude: ['/sign-in', '/sign-up', '/myevents', '/profile', '/contact', '/admin', '/resetpassword'], // pages to exclude
    robotsTxtOptions: {
      policies: [
        {
          userAgent: '*',
        ...
        {
          userAgent: '*',
          disallow: ['/sign-in', '/sign-up', '/myevents', '/profile', '/contact', '/admin', '/resetpassword'], // Block specific pages
        },
      ],
      additionalSitemaps: [
