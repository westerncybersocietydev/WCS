                            ...
                            >
                                <div className="bg-white rounded-lg shadow-lg p-8 md:p-12">
                                    ...
                                    <p className="text-gray-700 text-lg leading-relaxed mb-6">
                                        Recruit Ready is your ultimate preparation guide for the upcoming recruitment season.
                                        We bring you industry experts and successful students to share their secrets
