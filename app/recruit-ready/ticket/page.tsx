...
export default function RecruitReadyTicketPage() {
  ...
  // Determine price display - non-members pay $2
  const ticketPrice = "$2.00";
  const priceLabel = "Non-member Price";
              ...
              <div className="text-white text-center px-6 py-12 max-w-3xl mx-auto">
                ...
                <p className="text-sm md:text-lg md:text-xl leading-relaxed">
                  {profileData?.plan === "VIP"
                    ...
                    : `Non-member Tickets — ${ticketPrice} CAD`}
                </p>
              </div>
            </div>
          </section>
                  ...
                  <>
                    <div className="mb-6 p-4 bg-yellow-50 rounded-lg border border-yellow-200">
                      <p className="text-yellow-800">
                        ...
                        Non-member Tickets: {ticketPrice} CAD. VIP members get free tickets.
                      </p>
                    </div>
