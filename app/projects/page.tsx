    ...
    <div className="relative font-sans antialiased w-full h-[70vw] md:h-[60vw] lg:h-[50vw] 2xl:h-[40vw] cursor-pointer transition-transform transform hover:scale-105 group flex flex-col overflow-hidden rounded-lg">
      ...
      <div className="p-5 h-2/4 text-white flex-grow flex flex-col relative">
        ...
        <div className="flex space-x-5 text-md font-bold w-full">
          <p>
            <i className="fa-solid fa-user-group"></i> {peopleCount}
          </p>
          <p>
            <i className="fa-solid fa-bars-progress"></i> {difficulty}
          </p>
          {status === "Archived" && (
            <p className="ml-auto">
              <i className="fa-solid fa-box-archive"></i> {year}
            </p>
          )}
        </div>
      </div>
              ...
              <div className="absolute inset-0 bg-black bg-opacity-50 flex items-center justify-center">
                <div className="text-white text-center px-6 py-12 max-w-3xl mx-auto">
                  ...
                  <p className="text-sm md:text-lg md:text-xl leading-relaxed">
                    Our Student Initiative Projects (SIP) showcase creative
                    solutions developed by our members, tackling real-world
                    challenges through teamwork and technical skills. Each
                    project represents our commitment to learning, growth, and
            ...
            <section className="mt-10">
              ...
              >
                <div className="flex items-center">
                  <h1 className="text-2xl font-bold mx-auto md:mx-2 text-gray-800">
                    Student Innovation Projects
                  </h1>
                </div>
