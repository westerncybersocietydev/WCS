                ...
                <div className="flex flex-col lg:flex-row bg-white w-full rounded-lg shadow-lg overflow-hidden">
                  ...
                  <div className="md:w-2/3 h-2/3 md:h-full p-2 md:p-5 w-full flex flex-col justify-between">
                    <div className="px-2 text-gray-800">
                      ...
                      <p className="font-semibold ml-2 text-sm md:text-base mb-1">
                      ...
                      <p className="font-semibold ml-2 text-sm md:text-base mb-3">
                        <i className="fa-solid fa-tag"></i>
                        <span className="ml-2 font-normal text-gray-700">
                          {selectedItem.price}
                        </span>
                      </p>
                      <p className="font-normal text-gray-700 ml-2 max-w-lg text-sm md:text-base mb-2 leading-relaxed">
